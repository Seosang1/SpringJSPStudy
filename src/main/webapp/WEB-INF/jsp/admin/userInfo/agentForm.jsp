			...
			<form id="frm" action="" method="post">
				...
				<table class="tbl tbl_form mt5">
					...
					<tbody>
						...
						<tr>
							<th scope="row">성명</th>
							<td><input type="text" class="w100p" name="nm" value="${eo.nm}" /></td>
							<th scope="row">아이디</th>
							<td>${eo.userId}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3">
								...
								<input type="text" class="w10p mr10" name="zip" value="${eo.zip }" readonly />
								<input type="text" class="w70p mr10" name="adres" value="${eo.adres}" readonly />
							</td>
						</tr>
						<tr>
