...
$(function(){
	cwmaFile = new cwma.file({fileLayer:'#fileLayer', parntsSe:'ATCH0005', parntsSn:$('[name="sn"]').val(), allowExt:['JPG', 'JPEG', 'PNG'], maxSize:1});
...
<body>
	<form action="${empty eo?'insert':'update'}.do" id="frm" method="post">
		...
		<table class="tbl tbl_form">
			...
			<tbody>
				<tr>
					<th scope="row"><em class="required">*</em>팝업명</th>
					<td>
						<input type="text" class="w100p" name="popupNm" title="팝업명" value="${eo.popupNm}" required/>
					</td>
				</tr>
				<tr>
