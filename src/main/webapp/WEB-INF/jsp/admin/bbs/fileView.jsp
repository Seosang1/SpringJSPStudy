...
<head>
	<script type="text/javascript">
		...
		$(function(){
			...
			cwmaCnFile = new cwma.file({fileLayer:'#fileLayer2', parntsSe:'ATCH0001', parntsSn:$('[name="sn"]').val()});
			cwmaFile.setFileList();		
			cwmaCnFile.setFileCnList();		
	...
	<form action="" id="frm" method="post">
		...
		<table class="tbl tbl_form">
			...
			<tbody>
				...
				<tr>
					<td colspan="4" class="" id="fileLayer2">
					</td>
				</tr>
				<tr>
		...
		<div class="btn_wrap">
			...
			<div class="fr txt_right">
				<a href="fileForm.do" class="btn normal green mr10 btnForm"><i class="far fa-edit mr5"></i>수정</a>
