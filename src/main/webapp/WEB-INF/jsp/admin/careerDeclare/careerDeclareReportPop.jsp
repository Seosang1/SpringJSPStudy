    ...
    <body>
		...
		if(browser == "chrome"){
			function SetOZParamters_OZViewer(){
				...
				oz.sendToActionScript("connection.reportname","grade/${reportName}.ozr");
				...
				oz.sendToActionScript("export.filename","${reportName}_${brffcNm}");
				return true;
			}
			var opt = [];
// 			opt["mstyle"] = true;
			...
			function ZTInstallEndCommand_ZTransferX(param1,param2) { 
	            ...
	            Insert_OZViewer_Param("connection.reportname", "${reportName}");
	            Insert_OZViewer_Param("connection.pcount","1");
	            Insert_OZViewer_Param("connection.args1","no=${no}");
        ...
        <div id= "InstallOZViewer">
            ...
            if(browser == "explorer"){
				...
				function savePDF() { //pdf 파일로 저장
					...
					OZReportViewer.ScriptEx("save","export.format=pdf;export.path=C:\\temp;export.mode=normal;export.filename="+"${reportName}_${brffcNm}.pdf;export.confirmsave=false",";")
				}
