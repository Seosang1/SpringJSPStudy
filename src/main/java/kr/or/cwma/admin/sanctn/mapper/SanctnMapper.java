package kr.or.cwma.admin.sanctn.mapper;
...
public interface SanctnMapper {
	 ...
	 * @return
	 */
	public int selectSanctnListCnt(SanctnSearchVO vo);
	 ...
	 * @return
	 */
	public int selectSanctnProgrsListCnt(SanctnSearchVO vo);
	 ...
	 * @return
	 */
	public List<SanctnVO> selectSanctnProgrsList(SanctnSearchVO vo);
	 ...
	 * @return
	 */
	public SanctnVO selectLastProgrs(SanctnVO vo);
	 ...
	 * @return
	 */
	public Integer chkSanctnProgrs(SanctnVO vo);
	 ...
	 * @param vo
	 */
	public void updateSanctnProgrsMain(SanctnVO vo);
	 ...
	 * @throws SQLException 
	 */
	public List<Map<String, Object>> selectSanctnProgrsListXls(SanctnSearchVO vo) throws SQLException;
